...
| **2. Tone detection is fragile**             | A shift from VADER → BERT triples the estimated effect (‑2 % → ‑17 %). The labeler you pick will steer any ML‑based ranking.                       |  If using sentiment scores for ordering, let ops staff A/B test alternative models. Expose a small “Why am I seeing this review?” tooltip.            |
