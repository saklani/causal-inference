...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Sentiment Analysis Disagreement")
    parser.add_argument("--vader", help="VADER sentiment analysis file", default='reviews-25000-analysis-vader.csv')
    parser.add_argument("--bert", help="BERT sentiment analysis file", default='reviews-25000-analysis-bert.csv')
